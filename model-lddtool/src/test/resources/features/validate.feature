...
| NASA-PDS/pds4-information-model#752  | "Update Constraints on Author/Editor Lists (JIRA-CCB-356)"                 | "github752"  |           6 | "totalErrors" | "SCHEMATRON_ERROR" | "-t {resourceDir}/github752" | "" |
| NASA-PDS/pds4-information-model#753  | "added nA & microA to Units_of_Current (JIRA-CCB-16)"                      | "github753"  |           0 | "totalErrors" | "-t {resourceDir}/github753/pc__d139.xml" | "PDS4_MARS2020_IngestLDD.xml" | "" |
...
| NASA-PDS/pds4-information-model#829  | "added mrad/pixel to Units_of_Pixel_Resolution_Angular (JIRA-CCB-38)"      | "github829"  |           6 |  "totalErrors" | "-t {resourceDir}/github829" | "PDS4_HST_IngestLDD.xml" | "" |
