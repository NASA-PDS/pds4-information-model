Feature: <testId>
  ...
  Scenario Outline: Comparing lddtool output files to expected files
    ...
    Examples:
      ...
      | "NASA-PDS/pds4-information-model#867Pa" | "Check schema for 1P00"                                                         | "src/test/resources/data/update_version/github867/1P00"  | "target/generated-files/github867Pa" | "-p -V 1P00"                                    | "PDS4_PDS_1P00.xsd"             | "PDS4_PDS_1P00.xsd"                   | "PDS4 XML/Schema"                |
      | "NASA-PDS/pds4-information-model#867Pb" | "Check schematron for 1P00"                                                     | "src/test/resources/data/update_version/github867/1P00"  | "target/generated-files/github867Pb" | "-p -V 1P00"                                    | "PDS4_PDS_1P00.sch"             | "PDS4_PDS_1P00.sch"                   | "PDS4 Schematron for Name Space" |
      | "NASA-PDS/pds4-information-model#867Pc" | "Check pins output for 1P00"                                                    | "src/test/resources/data/update_version/github867/1P00"  | "target/generated-files/github867Pc" | "-p -V 1P00"                                    | "dd11179_GenPClass.pins"        | "dd11179_GenPClass.pins"              | ""                               |
      | "NASA-PDS/pds4-information-model#867Qa" | "Check schema for 1Q00"                                                         | "src/test/resources/data/update_version/github867/1Q00"  | "target/generated-files/github867Pa" | "-p -V 1Q00"                                    | "PDS4_PDS_1Q00.xsd"             | "PDS4_PDS_1Q00.xsd"                   | "PDS4 XML/Schema"                |
      | "NASA-PDS/pds4-information-model#867Qb" | "Check schematron for 1Q00"                                                     | "src/test/resources/data/update_version/github867/1Q00"  | "target/generated-files/github867Pb" | "-p -V 1Q00"                                    | "PDS4_PDS_1Q00.sch"             | "PDS4_PDS_1Q00.sch"                   | "PDS4 Schematron for Name Space" |
      | "NASA-PDS/pds4-information-model#867Qc" | "Check pins output for 1Q00"                                                    | "src/test/resources/data/update_version/github867/1Q00"  | "target/generated-files/github867Pc" | "-p -V 1Q00"                                    | "dd11179_GenPClass.pins"        | "dd11179_GenPClass.pins"              | ""                               |
